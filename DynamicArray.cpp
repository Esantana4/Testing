...
// Precondition: A sorted DynamicArray, valid first and last indexes
...
// Precondition: An o-stream object, A DynamicArray object
// Postcondition: The DynamicArray is output to the provided o-stream.
template <typename T>
